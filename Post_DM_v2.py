...
if __name__ == "__main__":
            #initial starting ID:
    i = 0
    os.chdir(r"V:\ABAQUS\Steel_174PH\Models") # need to change !!!
    ...
    while i <= 199:
        ...
        mdb.JobFromInputFile(name='No_%d_include' % i, \
            inputFileName='V:\\ABAQUS\\Steel_174PH\\Models\\No_%d_include.inp' % i, \
            type=ANALYSIS, atTime=None, waitMinutes=0, waitHours=0, queue=None, \
            memory=90, memoryUnits=PERCENTAGE, getMemoryFromAnalysis=True, \
            explicitPrecision=SINGLE, nodalOutputPrecision=SINGLE, \
            userSubroutine='V:\\ABAQUS\\Steel_174PH\\Models\\Huang_17PH_kinematic.for', \
        ...
        odb = session.openOdb(name='V:/ABAQUS/Steel_174PH/Models/No_%d_include.odb' % i)
        ...
        session.printToFile(fileName='V:/ABAQUS/Steel_174PH/DM/Energy_%d' % i, \
        ...
        session.printToFile(fileName='V:/ABAQUS/Steel_174PH/DM/vonMises_%d' % i, \
            format=PNG, canvasObjects=(session.viewports['Viewport: 1'], ))
